...
- **LEDs que siguen al ordenador.** Con `LED_Feedback` activado, un CC o una nota que llega por USB enciende o apaga los botones toggle que lo envían, así que la pedalera enseña lo que de verdad está encendido cuando cambias un efecto desde una DAW o desde el editor del ampli.
